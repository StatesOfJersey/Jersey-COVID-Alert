...
import { StyleSheet, ViewStyle, Text, View, TouchableOpacity, Dimensions } from 'react-native';
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const typeToColors = {
    default: colors.buttons.default,
    secondary: colors.buttons.secondary,
    empty: colors.buttons.empty,
    danger: colors.buttons.danger
  };
  const buttonColors = typeToColors[type];
  ...
  return (
    ...
    >
      <TouchableOpacity
        style={[styles.button, { backgroundColor: foregroundColor }, type === 'empty' && styles.buttonEmpty]}
