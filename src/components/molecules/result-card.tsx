...
type Result = 'noSymptomsWell' | 'noSymptomsNotWell' | 'riskGroup' | 'recovered' | 'virusIsolation';
  ...
  if (result === 'noSymptomsWell' || result === 'noSymptomsNotWell') {
    return (
      <View style={styles.card}>
        ...
        <Spacing s={12} />
        <Button width="100%" type="empty" onPress={() => navigation.navigate('symptoms.history')}>
    ...
    return (
      <View style={styles.card}>
        <Markdown style={{}}>{checkerThankYouText[result]}</Markdown>
        <Button width="100%" type="empty" onPress={() => link(urlsMap.riskGroupCocooning)}>
        ...
        <Spacing s={12} />
        <Button width="100%" type="empty" onPress={() => link(urlsMap.riskGroup)}>
